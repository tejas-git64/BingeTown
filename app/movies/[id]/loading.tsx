...
import loadingCircle from "@/public/gifs/icons8-loading-circle.gif";
            ...
            <div className="mx-auto h-auto w-full">
              ...
              >
                {arr.map(() => (
                  <p
                    key={Math.random()}
                    className="mr-2 h-28 w-40 flex-shrink-0 animate-pulse rounded-lg bg-neutral-600 md:h-36 md:w-52"
                  ></p>
                ))}
              </ul>
              <ul
