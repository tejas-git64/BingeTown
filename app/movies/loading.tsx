      ...
      >
        {items.map((_, i) => (
          ...
          >
            ...
            <div className="h-3 w-full whitespace-pre-line rounded-full bg-neutral-600"></div>
            <div className="my-1 h-[10.5px] w-20 whitespace-pre-line rounded-full bg-neutral-600"></div>
            <h3 className="h-[10.5px] w-12 whitespace-pre-line rounded-full bg-neutral-600"></h3>
          </div>
        ))}
      </div>
    </>
