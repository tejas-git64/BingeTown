...
export default function NotFound() {
  return (
    <>
      <div className='flex h-[calc(100dvh-10dvh)] w-full flex-col items-center justify-center bg-neutral-800 bg-[url("https://i.pinimg.com/originals/c5/dc/40/c5dc403178d1afa38b1ea167333b8c2d.jpg")] bg-cover bg-center bg-no-repeat'>
