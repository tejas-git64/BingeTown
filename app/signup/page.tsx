...
export default function SignUp() {
  ...
  const SignContext = useContext(LayoutContext);
  ...
  return (
    <>
      <div className="grid h-[calc(100dvh-0dvh)] w-full place-items-center bg-neutral-900 p-4">
        <Link
          href="/"
        ...
        <form className="mt-10 flex h-[630px] w-full flex-col items-start justify-center rounded-xl bg-zinc-900 p-4 px-6 shadow-xl md:w-[450px] md:px-10">
          ...
          />
          {error && (
            <h4 className="mx-auto mt-1 w-full rounded-md text-center font-extrabold text-red-500 md:w-80">
              {error}
            </h4>
          )}
          {signedIn && (
