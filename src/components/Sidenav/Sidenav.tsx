...
export default function Sidenav() {
	...
	return (
		<>
			<div
				className={`fixed top-0 z-20 h-[1000px] w-full animate-none border-l-[1px] border-neutral-800 bg-neutral-900 transition-all delay-75 ease-in-out sm:w-96 ${
				...
				<div className='flex w-full justify-end px-6 py-7'>
					<button
						...
						<img src={close} alt='close-button' className='h-8 w-8' />
					</button>
				</div>
				...
				<button
					onClick={SignOut}
					className='mt-96 rounded-full border-none bg-teal-500 px-10 py-2 font-bold text-black outline-none'>
					Sign out
				</button>
			</div>
		</>
