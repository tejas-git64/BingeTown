import twit from "../../assets/images/icons8-twitter-30.png";
...
export default function Footer() {
	...
	return (
		<footer
			...
			<div className='flex h-56 w-auto justify-around'>
			...
			<div className='mx-auto my-6 flex h-12 w-full items-center justify-center md:w-96'>
				<h4 className='text-md mx-6 font-semibold text-gray-700 md:mr-12 md:whitespace-nowrap md:text-lg'>
					Look me up here
				</h4>
				<a href='https://twitter.com/yousurebro_tej'>
					<img
						src={twit}
						alt='twitter'
						className='mr-4 h-10 w-10 p-2 hover:invert-[2] md:h-12 md:w-12'
					/>
				</a>
				...
				<a href='https://github.com/tejas-git64'>
					<img
						src={github}
						alt='github'
						className='mr-4 h-10 w-10 hover:invert-[2] md:h-12 md:w-12'
					/>
				</a>
			</div>
