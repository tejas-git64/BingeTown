  ...
  ({ name, first_air_date, vote_average, poster_path, id }: TVDiscover) => {
    ...
    return (
      ...
      >
        <Image
          src={
            imgSrc || "/public/images/luca-nicoletti-O8CHmj0zgAg-unsplash.jpg"
          }
          alt="movie-poster"
          width={154}
          height={231}
          ...
          fetchPriority="high"
          onError={() =>
            setImgSrc("/public/images/luca-nicoletti-O8CHmj0zgAg-unsplash.jpg")
          }
        ...
        >
          ...
          >
            ...
            <Image src={watchlist} alt="add" className="title-watchlist-img" />
          </button>
          <button
            onClick={(e) => {
              e.preventDefault();
